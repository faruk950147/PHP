                                ...
                                <form action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" name="profile-title" class="form-control" placeholder="Enter Profile title" id="">
                                        </div>
                                        <div class="col-md-12 mb-3">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="bio" id="" placeholder="Enter Bio"></textarea>
                                        </div>
                                        <div class="col-md-12 mb-3">
